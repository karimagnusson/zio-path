...
This documentation is for version 2.0.1. Below is another for 2.0.2-RC5 that adds file download and upload and support for gzip, zip and tar.
...
def rel(parts: String*): ZDir // Relative to working directory. Returns full path.
def get(first: String, rest: String*): ZDir
def mkdirs(dirs: Seq[String]): IO[IOException, Seq[ZDir]]: Seq[ZDir]
```
